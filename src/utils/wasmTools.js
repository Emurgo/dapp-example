...
export const getTransactionOutput = (wasm, wasmOutputAddress, buildTransactionInput) =>
  wasm.TransactionOutput.new(
    wasmOutputAddress,
    wasm.Value.new(wasm.BigNum.from_str(buildTransactionInput.amount))
  );
...
export const getSignedTransaction = (wasm, wasmUnsignedTransaction, wasmWitnessSet) => wasm.Transaction.new(
  wasmUnsignedTransaction.body(),
  wasmWitnessSet,
